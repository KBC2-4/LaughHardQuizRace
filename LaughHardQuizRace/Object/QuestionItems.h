...
private:
    ...
    std::vector<std::vector<std::string>> answer = {
        ...
        {"大学生" , "18歳", "誰かがいるから", "机の下に隠れた", "帽子を被っていたから", "身だしなみをチェックするため", "本当に増える", "○",
        "リビング", "東京", "扉が風で飛んでなくなっていたから", "中国", "家族", "子供","99","本当は飛び降りていないから","北極","日本","えつ",
        "×","○","○","ドアの前","200円","本当は兄弟じゃないから","ワカメちゃん","車に乗っていたから","くじら","チョコレート",
        "60","中国","ナイル川","貝","揉む","たい","×","ウイルス","神奈川県","さけ","東京"}
    };
